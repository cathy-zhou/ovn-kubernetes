...
// PodWantsNetwork sees if the given pod needs to plumb over this given network specified by netconf,
...
func PodWantsNetwork(pod *kapi.Pod, nInfo NetInfo) (bool, map[string]*nettypes.NetworkSelectionElement, error) {
