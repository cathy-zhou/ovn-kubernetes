...
func RegisterOvnNorthdMetrics(clientset *kubernetes.Clientset, k8sNodeName string, metricsScrapeInterval int) {
	...
	go coverageShowMetricsUpdater(ovnNorthd, metricsScrapeInterval)
}
