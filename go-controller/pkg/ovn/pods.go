...
func (oc *DefaultL3Controller) lookupPortUUIDAndNodeName(logicalPort string) (portUUID string, logicalSwitch string, err error) {
...
func (oc *DefaultL3Controller) waitForNodeLogicalSwitch(nodeName string) (*nbdb.LogicalSwitch, error) {
...
func (oc *DefaultL3Controller) waitForNodeLogicalSwitchInCache(nodeName string) error {
...
func (oc *DefaultL3Controller) assignPodAddresses(nodeName string) (net.HardwareAddr, []*net.IPNet, error) {
	var (
...
func (oc *DefaultL3Controller) getPortAddresses(nodeName string, existingLSP *nbdb.LogicalSwitchPort) (net.HardwareAddr, []*net.IPNet, error) {
...
func (oc *DefaultL3Controller) delLSPOps(logicalPort, logicalSwitch, lspUUID string) ([]ovsdb.Operation, error) {
