...
func (oc *DefaultL3Controller) lookupPortUUIDAndSwitchName(logicalPort string) (portUUID string, switchName string, err error) {
...
func (oc *DefaultL3Controller) waitForNodeLogicalSwitch(switchName string) (*nbdb.LogicalSwitch, error) {
...
func (oc *DefaultL3Controller) waitForNodeLogicalSwitchInCache(switchName string) error {
...
func (oc *DefaultL3Controller) addRoutesGatewayIP(pod *kapi.Pod, podAnnotation *util.PodAnnotation, nodeSubnets []*net.IPNet) error {
...
func (oc *DefaultL3Controller) updatePodAnnotationWithRetry(origPod *kapi.Pod, podInfo *util.PodAnnotation) error {
...
func (oc *DefaultL3Controller) assignPodAddresses(switchName string) (net.HardwareAddr, []*net.IPNet, error) {
	var (
...
func (oc *DefaultL3Controller) getPortAddresses(switchName string, existingLSP *nbdb.LogicalSwitchPort) (net.HardwareAddr, []*net.IPNet, error) {
...
func (oc *DefaultL3Controller) delLSPOps(logicalPort, switchName, lspUUID string) ([]ovsdb.Operation, error) {
