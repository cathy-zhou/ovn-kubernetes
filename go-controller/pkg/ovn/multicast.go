...
func (oc *DefaultL3Controller) createMulticastAllowPolicy(ns string, nsInfo *namespaceInfo) error {
...
func (oc *DefaultL3Controller) createDefaultDenyMulticastPolicy() error {
...
// Caller must hold the namespace's namespaceInfo object lock.
func (oc *DefaultL3Controller) createDefaultAllowMulticastPolicy() error {
