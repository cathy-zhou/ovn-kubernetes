...
func (oc *DefaultL3Controller) ensureRouteInfoLocked(podName ktypes.NamespacedName) (*externalRouteInfo, error) {
...
func (oc *DefaultL3Controller) getRouteInfosForNamespace(namespace string) []*externalRouteInfo {
...
func (oc *DefaultL3Controller) deleteRouteInfoLocked(name ktypes.NamespacedName) *externalRouteInfo {
...
func (oc *DefaultL3Controller) addPodExternalGW(pod *kapi.Pod) error {
	...
	if err != nil {
		...
		oc.RecordObjErrorEvent(err, pod)
		return nil
	}
...
func (oc *DefaultL3Controller) addPodExternalGWForNamespace(namespace string, pod *kapi.Pod, egress gatewayInfo) error {
...
func (oc *DefaultL3Controller) addExternalGWsForNamespace(egress gatewayInfo, nsInfo *namespaceInfo, namespace string) error {
	if egress.gws == nil {
...
func (oc *DefaultL3Controller) addGWRoutesForNamespace(namespace string, egress gatewayInfo) error {
...
func (oc *DefaultL3Controller) createBFDStaticRoute(bfdEnabled bool, gw string, podIP, gr, port, mask string) error {
...
func (oc *DefaultL3Controller) deleteLogicalRouterStaticRoute(podIP, mask, gw, gr string) error {
	p := func(item *nbdb.LogicalRouterStaticRoute) bool {
...
// pod gateway route
func (oc *DefaultL3Controller) deletePodGWRoute(routeInfo *externalRouteInfo, podIP, gw, gr string) error {
...
func (oc *DefaultL3Controller) deletePodExternalGW(pod *kapi.Pod) (err error) {
	podRoutingNamespaceAnno := pod.Annotations[util.RoutingNamespaceAnnotation]
	if podRoutingNamespaceAnno == "" {
		return nil
	}
...
func (oc *DefaultL3Controller) deleteGWRoutesForNamespace(namespace string, matchGWs sets.String) error {
...
func (oc *DefaultL3Controller) deleteGWRoutesForPod(name ktypes.NamespacedName, podIPNets []*net.IPNet) (err error) {
...
func (oc *DefaultL3Controller) addGWRoutesForPod(gateways []*gatewayInfo, podIfAddrs []*net.IPNet, podNsName ktypes.NamespacedName, node string) error {
...
// used when disableSNATMultipleGWs=true
func (oc *DefaultL3Controller) addOrUpdatePodSNATReturnOps(nodeName string, extIPs, podIfAddrs []*net.IPNet, ops []ovsdb.Operation) ([]ovsdb.Operation, error) {
...
// by ecmp routes
func (oc *DefaultL3Controller) addHybridRoutePolicyForPod(podIP net.IP, node string) error {
...
func (oc *DefaultL3Controller) delHybridRoutePolicyForPod(podIP net.IP, node string) error {
	if config.Gateway.Mode == config.GatewayModeLocal {
...
func (oc *DefaultL3Controller) delAllHybridRoutePolicies() error {
...
func (oc *DefaultL3Controller) delAllLegacyHybridRoutePolicies() error {
	// nuke all the policies
	p := func(item *nbdb.LogicalRouterPolicy) bool {
...
func (oc *DefaultL3Controller) cleanUpBFDEntry(gatewayIP, gatewayRouter, prefix string) error {
...
func (oc *DefaultL3Controller) extSwitchPrefix(nodeName string) (string, error) {
...
func (oc *DefaultL3Controller) cleanExGwECMPRoutes() {
	start := time.Now()
	defer func() {
...
func (oc *DefaultL3Controller) buildClusterECMPCacheFromNamespaces(clusterRouteCache map[string][]string) {
...
func (oc *DefaultL3Controller) buildClusterECMPCacheFromPods(clusterRouteCache map[string][]string) {
...
func (oc *DefaultL3Controller) buildOVNECMPCache() map[string][]*ovnRoute {
	p := func(item *nbdb.LogicalRouterStaticRoute) bool {
