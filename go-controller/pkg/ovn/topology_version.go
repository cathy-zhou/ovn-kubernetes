...
func (oc *DefaultL3Controller) ovnTopologyCleanup() error {
...
func (cInfo *controllerInfo) updateL3TopologyVersion() error {
	...
	err := libovsdbops.UpdateLogicalRouterSetExternalIDs(cInfo.nbClient, &logicalRouter)
	if err != nil {
...
func (oc *DefaultL3Controller) reportTopologyVersion(ctx context.Context) error {
	err := oc.controllerInfo.updateL3TopologyVersion()
	if err != nil {
		return err
	}
...
func (oc *DefaultL3Controller) cleanTopologyAnnotation() error {
...
func (oc *DefaultL3Controller) determineOVNTopoVersionFromOVN() (int, error) {
