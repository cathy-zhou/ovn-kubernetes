...
func (oc *DefaultL3Controller) cleanupStalePodSNATs(nodeName string, nodeIPs []*net.IPNet) error {
...
func (oc *DefaultL3Controller) gatewayInit(nodeName string, clusterIPSubnet []*net.IPNet, hostSubnets []*net.IPNet,
...
// the gateway router
func (oc *DefaultL3Controller) addExternalSwitch(prefix, interfaceID, nodeName, gatewayRouter, macAddress, physNetworkName string, ipAddresses []*net.IPNet, vlanID *uint) error {
...
func (oc *DefaultL3Controller) addPolicyBasedRoutes(nodeName, mgmtPortIP string, hostIfAddr *net.IPNet, otherHostAddrs []string) error {
	var l3Prefix string
...
// N+2 is fully made.
func (oc *DefaultL3Controller) syncPolicyBasedRoutes(nodeName string, matches sets.String, priority, nexthop string) error {
...
func (oc *DefaultL3Controller) findPolicyBasedRoutes(priority string) ([]*nbdb.LogicalRouterPolicy, error) {
...
func (oc *DefaultL3Controller) createPolicyBasedRoutes(match, priority, nexthops string) error {
	intPriority, _ := strconv.Atoi(priority)
...
func (oc *DefaultL3Controller) deletePolicyBasedRoutes(policyID, priority string) error {
