...
func (oc *DefaultL3Controller) updateStaleDefaultDenyACLNames(npType knet.PolicyType, gressSuffix string) error {
...
func (oc *DefaultL3Controller) syncNetworkPolicies(networkPolicies []interface{}) error {
...
func (oc *DefaultL3Controller) addPolicyToDefaultPortGroups(np *networkPolicy, aclLogging *ACLLoggingLevels) error {
...
func (oc *DefaultL3Controller) delPolicyFromDefaultPortGroups(np *networkPolicy) error {
	return oc.sharedNetpolPortGroups.DoWithLock(np.namespace, func(pgKey string) error {
...
func (oc *DefaultL3Controller) createDefaultDenyPGAndACLs(namespace, policy string, aclLogging *ACLLoggingLevels) error {
	ingressPGName := defaultDenyPortGroupName(namespace, ingressDefaultDenySuffix)
...
// must be called with defaultDenyPortGroups lock
func (oc *DefaultL3Controller) deleteDefaultDenyPGAndACLs(namespace, policy string) error {
...
func (oc *DefaultL3Controller) updateACLLoggingForPolicy(np *networkPolicy, aclLogging *ACLLoggingLevels) error {
	np.RLock()
	defer np.RUnlock()
	if np.deleted {
		return nil
...
func (oc *DefaultL3Controller) updateACLLoggingForDefaultACLs(ns string, nsInfo *namespaceInfo) error {
...
func (oc *DefaultL3Controller) handleNetPolNamespaceUpdate(namespace string, nsInfo *namespaceInfo) error {
...
func (oc *DefaultL3Controller) getNewLocalPolicyPorts(np *networkPolicy,
...
// if there are problems with fetching port info from logicalPortCache, pod will be added to errObjs.
func (oc *DefaultL3Controller) getExistingLocalPolicyPorts(np *networkPolicy,
	objs ...interface{}) (policyPortsToUUIDs map[string]string, policyPortUUIDs []string, errObjs []interface{}) {
...
func (oc *DefaultL3Controller) denyPGAddPorts(np *networkPolicy, portNamesToUUIDs map[string]string, ops []ovsdb.Operation) error {
	var err error
...
func (oc *DefaultL3Controller) denyPGDeletePorts(np *networkPolicy, portNamesToUUIDs map[string]string, useLocalPods bool,
...
func (oc *DefaultL3Controller) handleLocalPodSelectorAddFunc(np *networkPolicy, objs ...interface{}) error {
	np.RLock()
	defer np.RUnlock()
	if np.deleted {
		return nil
...
func (oc *DefaultL3Controller) handleLocalPodSelectorDelFunc(np *networkPolicy, objs ...interface{}) error {
	np.RLock()
	defer np.RUnlock()
	if np.deleted {
		return nil
...
func (oc *DefaultL3Controller) addLocalPodHandler(policy *knet.NetworkPolicy, np *networkPolicy) error {
...
// that information.
func (oc *DefaultL3Controller) createNetworkPolicy(policy *knet.NetworkPolicy, aclLogging *ACLLoggingLevels) (*networkPolicy, error) {
...
func (oc *DefaultL3Controller) addNetworkPolicy(policy *knet.NetworkPolicy) error {
...
func (oc *DefaultL3Controller) buildNetworkPolicyACLs(np *networkPolicy, aclLogging *ACLLoggingLevels) []*nbdb.ACL {
	acls := []*nbdb.ACL{}
...
func (oc *DefaultL3Controller) deleteNetworkPolicy(policy *knet.NetworkPolicy) error {
	npKey := getPolicyKey(policy)
...
// that information.
func (oc *DefaultL3Controller) cleanupNetworkPolicy(np *networkPolicy) error {
...
func (oc *DefaultL3Controller) handlePeerPodSelectorAddUpdate(np *networkPolicy, gp *gressPolicy, objs ...interface{}) error {
	np.RLock()
	defer np.RUnlock()
	if np.deleted {
		return nil
...
// ingress/egress address set
func (oc *DefaultL3Controller) handlePeerPodSelectorDelete(np *networkPolicy, gp *gressPolicy, obj interface{}) error {
	np.RLock()
	defer np.RUnlock()
	if np.deleted {
		return nil
...
func (oc *DefaultL3Controller) handlePeerServiceAdd(np *networkPolicy, gp *gressPolicy, service *kapi.Service) error {
...
// pods that are selected by the Network Policy
func (oc *DefaultL3Controller) handlePeerServiceDelete(np *networkPolicy, gp *gressPolicy, service *kapi.Service) error {
	np.RLock()
	defer np.RUnlock()
	if np.deleted {
		return nil
...
func (oc *DefaultL3Controller) addPeerServiceHandler(
...
func (oc *DefaultL3Controller) addPeerPodHandler(podSelector *metav1.LabelSelector,
	...
	retryPeerPods := newRetryFrameworkMasterWithParameters(oc, oc.watchFactory,
...
func (oc *DefaultL3Controller) handlePeerNamespaceAndPodAdd(np *networkPolicy, gp *gressPolicy,
...
func (oc *DefaultL3Controller) handlePeerNamespaceAndPodDel(np *networkPolicy, gp *gressPolicy, obj interface{}) error {
	np.RLock()
	defer np.RUnlock()
	if np.deleted {
		return nil
...
func (oc *DefaultL3Controller) addPeerNamespaceAndPodHandler(namespaceSelector *metav1.LabelSelector,
...
func (oc *DefaultL3Controller) handlePeerNamespaceSelectorAdd(np *networkPolicy, gp *gressPolicy, objs ...interface{}) error {
	np.RLock()
	if np.deleted {
		np.RUnlock()
		return nil
...
func (oc *DefaultL3Controller) handlePeerNamespaceSelectorDel(np *networkPolicy, gp *gressPolicy, objs ...interface{}) error {
	np.RLock()
	if np.deleted {
		np.RUnlock()
		return nil
...
func (oc *DefaultL3Controller) peerNamespaceUpdate(np *networkPolicy, gp *gressPolicy) error {
	...
	nsInfo, nsUnlock := oc.namespaceManager.getNamespaceLocked(np.namespace, true)
...
func (oc *DefaultL3Controller) addPeerNamespaceHandler(
	namespaceSelector *metav1.LabelSelector,
...
func (oc *DefaultL3Controller) shutdownHandlers(np *networkPolicy) {
