...
func (bnc *BaseNetworkController) getPortGroupName(readableGroupName string) string {
	return bnc.GetNetworkScopedName(readableGroupName)
}
...
func (bnc *BaseNetworkController) defaultDenyPortGroupName(namespace, gressSuffix string) string {
	return hashedPortGroup(bnc.getPortGroupName(namespace)) + "_" + gressSuffix
}
...
func (bnc *BaseNetworkController) getNetworkPolicyPGName(namespace, name string) (pgName, readablePGName string) {
	...
	return hashedPortGroup(bnc.getPortGroupName(readableGroupName)), readableGroupName
}
