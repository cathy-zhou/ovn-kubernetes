...
func (oc *DefaultL3Controller) syncEgressFirewall(egressFirewalls []interface{}) error {
...
func (oc *DefaultL3Controller) addEgressFirewall(egressFirewall *egressfirewallapi.EgressFirewall) error {
...
func (oc *DefaultL3Controller) deleteEgressFirewall(egressFirewallObj *egressfirewallapi.EgressFirewall) error {
...
func (oc *DefaultL3Controller) updateEgressFirewallStatusWithRetry(egressfirewall *egressfirewallapi.EgressFirewall) error {
...
func (oc *DefaultL3Controller) addEgressFirewallRules(ef *egressFirewall, hashedAddressSetNameIPv4, hashedAddressSetNameIPv6 string, efStartPriority int, aclLogging *ACLLoggingLevels) error {
	for _, rule := range ef.egressRules {
		var action string
...
func (oc *DefaultL3Controller) createEgressFirewallRules(priority int, match, action, externalID string, aclLogging *ACLLoggingLevels) error {
...
func (oc *DefaultL3Controller) deleteEgressFirewallRules(externalID string) error {
...
func (oc *DefaultL3Controller) updateACLLoggingForEgressFirewall(egressFirewallNamespace string, nsInfo *namespaceInfo) (bool, error) {
