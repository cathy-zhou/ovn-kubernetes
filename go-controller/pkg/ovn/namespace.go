...
func (oc *DefaultL3Controller) syncNamespaces(namespaces []interface{}) error {
...
func (oc *DefaultL3Controller) getRoutingExternalGWs(nsInfo *namespaceInfo) *gatewayInfo {
	res := gatewayInfo{}
...
func (oc *DefaultL3Controller) getRoutingPodGWs(nsInfo *namespaceInfo) map[string]gatewayInfo {
	// return a copy of the object so it can be handled without the
	// namespace locked
...
func (oc *DefaultL3Controller) addPodToNamespace(ns string, ips []*net.IPNet) (*gatewayInfo, map[string]gatewayInfo, []ovsdb.Operation, error) {
...
func (oc *DefaultL3Controller) multicastUpdateNamespace(ns *kapi.Namespace, nsInfo *namespaceInfo) error {
...
// previously allowed.
func (oc *DefaultL3Controller) multicastDeleteNamespace(ns *kapi.Namespace, nsInfo *namespaceInfo) error {
...
func (oc *DefaultL3Controller) AddNamespace(ns *kapi.Namespace) error {
...
func (oc *DefaultL3Controller) configureNamespace(nsInfo *namespaceInfo, ns *kapi.Namespace) error {
	var errors []error
...
func (oc *DefaultL3Controller) updateNamespace(old, newer *kapi.Namespace) error {
	var errors []error
...
func (oc *DefaultL3Controller) ensureNamespaceLocked(ns string, readOnly bool, namespace *kapi.Namespace) (*namespaceInfo, func(), error) {
	oc.namespacesMutex.Lock()
	nsInfo := oc.namespaces[ns]
	nsInfoExisted := false
	if nsInfo == nil {
...
func (oc *DefaultL3Controller) createNamespaceAddrSetAllPods(ns string) (addressset.AddressSet, error) {
	var ips []net.IP
