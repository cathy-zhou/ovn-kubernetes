...
type secondaryL3MasterEventHandler struct {
...
func (oc *SecondaryL3Controller) newRetryFrameworkMasterWithParameters(
	objectType reflect.Type,
	syncFunc func([]interface{}) error,
	extraParameters interface{}) *retry.RetryFramework {
	eventHandler := &secondaryL3MasterEventHandler{
		masterEventHandler: masterEventHandler{},
		objType:            objectType,
...
func (h *secondaryL3MasterEventHandler) AreResourcesEqual(obj1, obj2 interface{}) (bool, error) {
...
func (h *secondaryL3MasterEventHandler) GetInternalCacheEntry(obj interface{}) interface{} {
	switch h.objType {
...
func (h *secondaryL3MasterEventHandler) GetResourceFromInformerCache(key string) (interface{}, error) {
	return h.masterEventHandler.getResourceFromInformerCache(h.objType, h.watchFactory, key)
}

// RecordAddEvent records the add event on this given object.
func (h *secondaryL3MasterEventHandler) RecordAddEvent(obj interface{}) {
}

// RecordUpdateEvent records the udpate event on this given object.
func (h *secondaryL3MasterEventHandler) RecordUpdateEvent(obj interface{}) {
}

// RecordDeleteEvent records the delete event on this given object.
func (h *secondaryL3MasterEventHandler) RecordDeleteEvent(obj interface{}) {
}

// RecordSuccessEvent records the success event on this given object.
func (h *secondaryL3MasterEventHandler) RecordSuccessEvent(obj interface{}) {
}

// RecordErrorEvent records the error event on this given object.
func (h *secondaryL3MasterEventHandler) RecordErrorEvent(obj interface{}, reason string, err error) {
}

// IsResourceScheduled returns true if the given object has been scheduled.
// Only applied to pods for now. Returns true for all other types.
func (h *secondaryL3MasterEventHandler) IsResourceScheduled(obj interface{}) bool {
...
func (h *secondaryL3MasterEventHandler) AddResource(obj interface{}, fromRetryLoop bool) error {
	var err error
...
func (h *secondaryL3MasterEventHandler) UpdateResource(oldObj, newObj interface{}, inRetryCache bool) error {
	switch h.objType {
	case factory.PodType:
...
func (h *secondaryL3MasterEventHandler) DeleteResource(obj, cachedObj interface{}) error {
	switch h.objType {
	case factory.PodType:
		var portInfo *lpInfo
		pod := obj.(*kapi.Pod)
...
func (h *secondaryL3MasterEventHandler) SyncFunc(objs []interface{}) error {
...
func (h *secondaryL3MasterEventHandler) IsObjectInTerminalState(obj interface{}) bool {
...
func (oc *SecondaryL3Controller) getPortInfo(pod *kapi.Pod) *lpInfo {
...
func (oc *SecondaryL3Controller) addLogicalPort(pod *kapi.Pod, nadName string,
