...
func (n kNetworkPolicy) getPolicyData(networkPolicies []*knet.NetworkPolicy, policyPorts []string, peerNamespaces []string, tcpPeerPorts []int32, denyLogSeverity, allowLogSeverity nbdb.ACLSeverity) []libovsdb.TestData {
	...
	for _, networkPolicy := range networkPolicies {
		...
		if sharedPortGroupName != "" {
			egressAcls, ingressAcls := n.getSharedNMDefaultDenyAcls(networkPolicy, nil, denyLogSeverity)
...
func (n kNetworkPolicy) getSharedNMDefaultDenyAcls(np *knet.NetworkPolicy, ports []string, logSeverity nbdb.ACLSeverity) ([]*nbdb.ACL, []*nbdb.ACL) {
	egressAcls := []*nbdb.ACL{}
