...
func (oc *DefaultL3Controller) reconcileEgressIP(old, new *egressipv1.EgressIP) (err error) {
...
func (oc *DefaultL3Controller) reconcileEgressIPNamespace(old, new *v1.Namespace) error {
...
func (oc *DefaultL3Controller) reconcileEgressIPPod(old, new *v1.Pod) (err error) {
...
func (oc *DefaultL3Controller) reconcileCloudPrivateIPConfig(old, new *ocpcloudnetworkapi.CloudPrivateIPConfig) error {
...
func (oc *DefaultL3Controller) removePendingOpsAndGetResyncs(egressIPName, egressIP string) ([]egressipv1.EgressIP, error) {
	oc.eIPC.pendingCloudPrivateIPConfigsMutex.Lock()
	defer oc.eIPC.pendingCloudPrivateIPConfigsMutex.Unlock()
	ops, pending := oc.eIPC.pendingCloudPrivateIPConfigsOps[egressIPName]
	if !pending {
...
func (oc *DefaultL3Controller) executeCloudPrivateIPConfigChange(egressIPName string, toAssign, toRemove []egressipv1.EgressIPStatusItem) error {
	oc.eIPC.pendingCloudPrivateIPConfigsMutex.Lock()
	defer oc.eIPC.pendingCloudPrivateIPConfigsMutex.Unlock()
...
func (oc *DefaultL3Controller) executeCloudPrivateIPConfigOps(egressIPName string, ops map[string]*cloudPrivateIPConfigOp) error {
...
func (oc *DefaultL3Controller) validateEgressIPSpec(name string, egressIPs []string) (sets.String, error) {
...
// start going this.
func (oc *DefaultL3Controller) validateEgressIPStatus(name string, items []egressipv1.EgressIPStatusItem) (map[egressipv1.EgressIPStatusItem]string, map[egressipv1.EgressIPStatusItem]string) {
...
func (oc *DefaultL3Controller) addAllocatorEgressIPAssignments(name string, statusAssignments []egressipv1.EgressIPStatusItem) {
	oc.eIPC.allocator.Lock()
	defer oc.eIPC.allocator.Unlock()
...
func (oc *DefaultL3Controller) addEgressIPAssignments(name string, statusAssignments []egressipv1.EgressIPStatusItem, namespaceSelector, podSelector metav1.LabelSelector) error {
...
func (oc *DefaultL3Controller) addNamespaceEgressIPAssignments(name string, statusAssignments []egressipv1.EgressIPStatusItem, namespace *kapi.Namespace, podSelector metav1.LabelSelector) error {
	var pods []*kapi.Pod
	var err error
...
func (oc *DefaultL3Controller) addPodEgressIPAssignmentsWithLock(name string, statusAssignments []egressipv1.EgressIPStatusItem, pod *kapi.Pod) error {
...
func (oc *DefaultL3Controller) addPodEgressIPAssignments(name string, statusAssignments []egressipv1.EgressIPStatusItem, pod *kapi.Pod) error {
...
func (oc *DefaultL3Controller) deleteAllocatorEgressIPAssignmentIfExists(name, egressIP string) string {
	oc.eIPC.allocator.Lock()
	defer oc.eIPC.allocator.Unlock()
...
func (oc *DefaultL3Controller) deleteAllocatorEgressIPAssignments(statusAssignments []egressipv1.EgressIPStatusItem) {
	oc.eIPC.allocator.Lock()
	defer oc.eIPC.allocator.Unlock()
	for _, status := range statusAssignments {
		if eNode, exists := oc.eIPC.allocator.cache[status.Node]; exists {
...
func (oc *DefaultL3Controller) deleteEgressIPAssignments(name string, statusesToRemove []egressipv1.EgressIPStatusItem) error {
	oc.eIPC.podAssignmentMutex.Lock()
	defer oc.eIPC.podAssignmentMutex.Unlock()
...
func (oc *DefaultL3Controller) deleteNamespaceEgressIPAssignment(name string, statusAssignments []egressipv1.EgressIPStatusItem, namespace *kapi.Namespace, podSelector metav1.LabelSelector) error {
	var pods []*kapi.Pod
	var err error
	selector, _ := metav1.LabelSelectorAsSelector(&podSelector)
	if !selector.Empty() {
...
func (oc *DefaultL3Controller) deletePodEgressIPAssignments(name string, statusesToRemove []egressipv1.EgressIPStatusItem, pod *kapi.Pod) error {
	oc.eIPC.podAssignmentMutex.Lock()
	defer oc.eIPC.podAssignmentMutex.Unlock()
	podKey := getPodKey(pod)
...
func (oc *DefaultL3Controller) isEgressNodeReady(egressNode *kapi.Node) bool {
...
func (oc *DefaultL3Controller) isEgressNodeReachable(egressNode *kapi.Node) bool {
	oc.eIPC.allocator.Lock()
	defer oc.eIPC.allocator.Unlock()
...
func (oc *DefaultL3Controller) syncEgressIPs(namespaces []interface{}) error {
...
func (oc *DefaultL3Controller) syncPodAssignmentCache(egressIPCache map[string]egressIPCacheEntry) error {
	oc.eIPC.podAssignmentMutex.Lock()
	defer oc.eIPC.podAssignmentMutex.Unlock()
...
func (oc *DefaultL3Controller) syncStaleEgressReroutePolicy(egressIPCache map[string]egressIPCacheEntry) error {
...
// Upon failure, it may be invoked multiple times in order to avoid a pod restart.
func (oc *DefaultL3Controller) syncStaleSNATRules(egressIPCache map[string]egressIPCacheEntry) error {
...
func (oc *DefaultL3Controller) generateCacheForEgressIP() (map[string]egressIPCacheEntry, error) {
...
func (oc *DefaultL3Controller) isAnyClusterNodeIP(ip net.IP) *egressNode {
...
func (oc *DefaultL3Controller) patchReplaceEgressIPStatus(name string, statusItems []egressipv1.EgressIPStatusItem) error {
...
func (oc *DefaultL3Controller) assignEgressIPs(name string, egressIPs []string) []egressipv1.EgressIPStatusItem {
	oc.eIPC.allocator.Lock()
	defer oc.eIPC.allocator.Unlock()
...
func (oc *DefaultL3Controller) getSortedEgressData() ([]*egressNode, map[string]egressIPNodeStatus) {
...
func (oc *DefaultL3Controller) setNodeEgressAssignable(nodeName string, isAssignable bool) {
	oc.eIPC.allocator.Lock()
	defer oc.eIPC.allocator.Unlock()
...
func (oc *DefaultL3Controller) setNodeEgressReady(nodeName string, isReady bool) {
	oc.eIPC.allocator.Lock()
	defer oc.eIPC.allocator.Unlock()
	if eNode, exists := oc.eIPC.allocator.cache[nodeName]; exists {
...
func (oc *DefaultL3Controller) setNodeEgressReachable(nodeName string, isReachable bool) {
	oc.eIPC.allocator.Lock()
	defer oc.eIPC.allocator.Unlock()
	if eNode, exists := oc.eIPC.allocator.cache[nodeName]; exists {
...
func (oc *DefaultL3Controller) addEgressNode(nodeName string) error {
	var errors []error
...
func (oc *DefaultL3Controller) deleteEgressNode(nodeName string) error {
...
func (oc *DefaultL3Controller) initEgressIPAllocator(node *kapi.Node) (err error) {
	oc.eIPC.allocator.Lock()
	defer oc.eIPC.allocator.Unlock()
...
func (oc *DefaultL3Controller) setupNodeForEgress(node *v1.Node) error {
...
func (oc *DefaultL3Controller) deleteNodeForEgress(node *v1.Node) error {
...
func (oc *DefaultL3Controller) initClusterEgressPolicies(nodes []interface{}) error {
...
func (oc *DefaultL3Controller) addStandByEgressIPAssignment(podKey string, podStatus *podAssignmentState) error {
	podNamespace, podName := getPodNamespaceAndNameFromKey(podKey)
...
func (oc *DefaultL3Controller) checkEgressNodesReachability() {
...
func checkEgressNodesReachabilityIterate(oc *DefaultL3Controller) {
...
func (oc *DefaultL3Controller) isReachable(nodeName string, mgmtIPs []net.IP, healthClient healthcheck.EgressIPHealthClient) bool {
