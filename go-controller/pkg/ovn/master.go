...
// problems.
func (oc *DefaultL3Controller) syncNodeClusterRouterPort(node *kapi.Node, hostSubnets []*net.IPNet) error {
...
func (oc *DefaultL3Controller) deleteNodeLogicalNetwork(nodeName string) error {
