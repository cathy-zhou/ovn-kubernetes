...
// UpdateLogicalSwtichSetExternalIDs sets external IDs on the provided logical
// switch adding any missing, removing the ones set to an empty value and
// updating existing
func UpdateLogicalSwtichSetExternalIDs(nbClient libovsdbclient.Client, logicalSwitch *nbdb.LogicalSwitch) error {
...
// DeleteLogicalSwitchOps deletes the provided logical switch and returns
