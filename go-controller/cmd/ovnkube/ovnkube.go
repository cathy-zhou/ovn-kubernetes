...
import (
	...
	controllerManager "github.com/ovn-org/ovn-kubernetes/go-controller/pkg/controller-manager"
...
func runOvnKube(ctx *cli.Context, cancel context.CancelFunc) error {
	...
	if master != "" {
		...
		cm := controllerManager.NewControllerManager(ovnClientset, master, masterWatchFactory,
